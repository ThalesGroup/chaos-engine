...
import static com.thales.chaos.shellclient.ssh.SSHCredentials.privateKeyFromString;
import static com.thales.chaos.shellclient.ssh.SSHCredentials.publicKeyFromPrivateKey;
...
public class ChaosSSHCredentialsTest {
    ...
    @Before
    public void setUp () {
        sshCredentials = new ChaosSSHCredentials().withUsername(USERNAME).withKeyPair(PRIVATE_KEY, PUBLIC_KEY).withPasswordGenerator(PASSWORD_GENERATOR);
    }
