...
public class GcpComputeServiceTest {
    public static final String MY_AWESOME_PROJECT = "my-awesome-project";
    @Spy
    private GcpComputeService gcpComputeService;
    @Mock
    ...
    public void beforeEach () {
        ...
        gcpComputeService.setJsonKey("{  \"type\": \"service_account\",\n" + "  \"project_id\": \"project_id\",\n" + "  \"private_key_id\": \"private_key_id\",\n" + "  \"private_key\": \"" + iMadeThisJustForTheTest + "\",\n" + "  \"client_email\": \"chaos-engine-test@project_id.iam.gserviceaccount.com\",\n" + "  \"client_id\": \"100000000000000000000\",\n" + "  \"auth_uri\": \"https://accounts.google.com/o/oauth2/auth\",\n" + "  \"token_uri\": \"https://oauth2.googleapis.com/token\",\n" + "  \"auth_provider_x509_cert_url\": \"https://www.googleapis.com/oauth2/v1/certs\",\n" + "  \"client_x509_cert_url\": \"https://www.googleapis.com/robot/v1/metadata/x509/chaos-engine-test%40project_id.iam.gserviceaccount.com\"\n" + "}\n");
        gcpComputeService.setProjectId(MY_AWESOME_PROJECT);
    }

    @Test
    public void instanceClientTest () throws Exception {
        InstanceClient instanceClient = gcpComputeService.instanceClient(credentials);
        Assert.assertSame(credentials, instanceClient.getSettings().getCredentialsProvider().getCredentials());
    }

    @Test
    public void instanceClientUsingCommonCredentialsTest () throws Exception {
        InstanceClient instanceClient = gcpComputeService.instanceClientUsingCommonCredentials(credentials);
        Assert.assertSame(credentials, instanceClient.getSettings().getCredentialsProvider().getCredentials());
    }

    @Test
    public void googleCredentialsTest () throws Exception {
        ServiceAccountCredentials googleCredentials = (ServiceAccountCredentials) gcpComputeService.googleCredentials();
    ...
    public void projectNameTest () {
        ProjectName projectName = gcpComputeService.googleProject();
        assertEquals(MY_AWESOME_PROJECT, projectName.getProject());
    }
}