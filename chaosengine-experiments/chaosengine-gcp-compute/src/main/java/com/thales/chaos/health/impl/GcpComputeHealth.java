...
public class GcpComputeHealth extends AbstractPlatformHealth {
    @Autowired
    private GcpComputePlatform gcpComputePlatform;

    @Autowired
    GcpComputeHealth () {
        log.debug("Using GCP Compute Health Check for System Health verification");
    }

    @Override
    Platform getPlatform () {
        return gcpComputePlatform;
    }
}
