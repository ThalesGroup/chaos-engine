...
public class LoggingController {
    ...
    public String getLogLevel (@ApiParam(value = "The Java Class Path to get the logging level of (i.e., com.gemalto, com.gemalto.chaos.platform, org.springframework)") @PathVariable String loggingClass) {
